...
const Footer = () => {
    return (
        <div className='mt-20 border-t-2 border-t-[#1e293b] bg-[#151f36] py-16 px-4 text-gray-300'>
            <div className='mx-auto flex max-w-[940px] flex-col items-center px-4'>
                ...
                <div className='my-6 flex justify-center gap-4 md:w-[75%]'>
                    ...
                    <a href='https://www.linkedin.com/feed/' target='_blank'><FaLinkedin size={30} className='hover:text-[#38bdf8]' /></a>
                </div>
            </div>
        </div>
    );
